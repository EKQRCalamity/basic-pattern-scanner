...
Examples can be found under [minimal-example](https://github.com/EKQRCalamity/basic-pattern-scanner/tree/master/minimal-example). These point to a directory path, so if it is removed from the folder structure you will have to change it to a release on [crates.io](https://crates.io).
